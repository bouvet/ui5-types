	...
	namespace ui {
      ...
      */
	  ...
	  interface IContextMenu {
		  openAsContextMenu(oEvent: string, oOpenerRef: sap.ui.core.Element | Element);
	  }
      ...
      */
      class Item<T extends Item.Properties = Item.Properties> extends sap.ui.core.Element<T> {
      ...
      */
      class Icon extends sap.ui.core.Control<IconProperties> {
        ...
        */
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
		attachPress(oData: any, fnFunction: sap.ui.base.EventHandler<Icon>, oListener?: any): sap.ui.core.Icon;
		attachPress(fnFunction: sap.ui.base.EventHandler<Icon>): sap.ui.core.Icon;
      ...
      */
      class Element<T = any, U extends ElementAggregations = ElementAggregations> extends sap.ui.base.ManagedObject<T, U> {
        ...
        */
         ...
         * @returns Returns <code>this</code> to allow method chaining
        */
        addEventDelegate(oDelegate: EventDelegateProps, oThis?: any): sap.ui.core.Element;
      ...
      */
      abstract class Control<T extends ControlProperties = ControlProperties, U extends ControlAggregations = ControlAggregations> extends sap.ui.core.Element<T, U> {
	...
	*/
	class ListItem extends sap.ui.core.Item<ListItem.Properties> {
	  ...
	  */
	  ...
	  bindProperty<K extends keyof ListItem.Properties>(sProperty: K, oBindingInfo: base.PropertyBindingInfo<ListItem.Properties[K]>);
