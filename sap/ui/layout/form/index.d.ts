		...
		namespace layout {
			namespace form {
				...
				*/
				...
				interface FormElementAggregations extends sap.ui.core.ElementAggregations {
					fields?: sap.ui.core.Control[];
					label?: sap.ui.core.Label | string;
				}
		
				type FormElementSettings = FormElementProperties | FormElementAggregations;
				/**
				...
				*/
				export class FormElement extends sap.ui.core.Element<FormElementProperties, FormElementAggregations> {
				...
				interface FormContainerAggregations extends sap.ui.core.ElementAggregations {
				...
				*/
				export class FormContainer<T = { expandable?: boolean, expanded?: boolean, visible?: boolean }> extends sap.ui.core.Element<T, FormContainerAggregations> {
				...
				export class ResponsiveGridLayout extends sap.ui.layout.form.FormLayout {
				  ...
				  */
				  ...
				  constructor(mSettings?: {
					  breakpointL?: number, breakpointM?: number, breakpointXL?: number, columnsL?: number, columnsM?: number, columnsXL?: number,
					  emptySpanL?: number, emptySpanM?: number, emptySpanS?: number, emptySpanXL?: number, labelSpanL?: number, labelSpanM?: number,
					  labelSpanS?: number, labelSpanXL?: number
				   })
