...
declare namespace sap {
	namespace ui {
		namespace base {
			...
			type EventHandler<T extends EventProvider = EventProvider, U extends EventParameters = EventParameters> = (oEvent: Event<T, U>) => any;
		  /**
		   * An Event object consisting of an id, a source and a map of parameters
		   * @resource sap/ui/base/Event.js
		  */
		  export class Event<T extends EventProvider = EventProvider, U extends EventParameters = EventParameters> extends sap.ui.base.Object {
		  ...
		  */
		  ...
		  type PropertyBindingInfo<T> = SinglePropertyBindingInfo | MultiPropertyBindingInfo | {
			  /**
		  ...
		  */
		  export class ManagedObject<T = any, U = any> extends sap.ui.base.EventProvider {
			...
			*/
			bindAggregation(sName: keyof U, oBindingInfo: AggregationBindingInfo): sap.ui.base.ManagedObject;
			...
			*/
			 ...
			 * @returns reference to the instance itself
			*/
			bindProperty<K extends keyof T>(sName: K, oBindingInfo: PropertyBindingInfo<T[K]> | string): sap.ui.base.ManagedObject;
