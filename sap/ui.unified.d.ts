		...
		namespace unified {
			namespace calendar {
				...
				export class Month extends sap.ui.core.Control {
					 ...
					 */
					setLegend(
						oLegend: any | sap.ui.unified.CalendarLegend
					): sap.ui.unified.calendar.Month;
			...
			export class Calendar extends sap.ui.core.Control {
				...
				addAriaLabelledBy(
					vAriaLabelledBy: any | sap.ui.core.Control
				): typeof sap.ui.unified.Calendar;
			...
			export class ShellOverlay extends sap.ui.core.Control {
				 ...
				 */
				setShell(
					oShell: any | sap.ui.unified.ShellLayout
				): sap.ui.unified.ShellOverlay;
			}
			/**
